          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                if($photo == null){ ?>
                <img class="img-profile rounded-circle" src="<?php echo base_url('assets/user/profile_null.png') ; ?>">
                <?php }else{ ?>
                <img class="img-profile rounded-circle" src="<?php echo base_url('assets/uploads/images/'.$this->session->userdata('photo')); ?>">
                <?php };?>
              </a>
